...
export type ChatPart =
  ...
  | { type: "image"; mimeType: string; data?: string; src?: string }
...
export const chatStyles = css`
  ...
  /* Size container so nested cards can bound themselves to the visible
     transcript area with container-query units. */
  .chat-wrap { position: relative; flex: 1 1 auto; min-height: 0; overflow: hidden; container-type: size; }
